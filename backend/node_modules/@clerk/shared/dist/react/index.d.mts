...
}>(params: T) => PaginatedResources<CommerceStatementResource, T extends {
    infinite: true;
} ? true : false>;
...
declare const usePaymentAttempts: <T extends PagesOrInfiniteOptions & {
    ...
    for: "organization" | "user";
}>(params: T) => PaginatedResources<CommercePaymentResource, T extends {
    infinite: true;
} ? true : false>;
...
declare const usePaymentMethods: <T extends PagesOrInfiniteOptions & {
    ...
    for: "organization" | "user";
}>(params: T) => PaginatedResources<CommercePaymentSourceResource, T extends {
    infinite: true;
} ? true : false>;
...
declare const usePlans: <T extends PagesOrInfiniteOptions & {
    ...
    for: "organization" | "user";
}>(params: T) => PaginatedResources<CommercePlanResource, T extends {
    infinite: true;
} ? true : false>;
...
type UseCheckoutOptions$1 = {
    for?: 'organization';
    planPeriod: CommerceSubscriptionPlanPeriod;
    planId: string;
};
declare const useCheckout: (options?: UseCheckoutOptions$1) => __experimental_UseCheckoutReturn;
